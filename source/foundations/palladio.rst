...
Palladio :cite:p:`a-reussner2016a` is a modeling and analysis approach for component-based software architectures. The modeling is done in collaboration of multiple roles as described in the section about :ref:`foundations/palladio:models`. :doc:`Analyses </analysis/index>` are done by quality analysts.

Models
######

The Palladio approach distinguishes five roles. Four of these roles model system aspects that are required to capture a holistic view on the overall software architecture. :numref:`fig_palladio_rolesandmodels` illustrates these four roles and the models they create.

.. _fig_palladio_rolesandmodels:
.. figure:: _images/palladio-roles-and-models.svg
   :alt: Visualization of four roles and corresponding models that contribute to a full Palladio architecture model

   Roles and models describing a full software architecture according to Palladio

In the following sections, we briefly describe the models and the roles that create these models.
